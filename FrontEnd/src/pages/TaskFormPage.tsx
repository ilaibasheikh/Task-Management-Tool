    ...
    <section className="page compact-page">
      <header className="page-header">
        <div>
          ...
          <p>Set owner, priority, status, category, and due date.</p>
        </div>
      </header>
      <form className="form-stack task-form" onSubmit={submit}>
        ...
        <label>Assigned user id<input value={task.assignedUserId ?? ''} onChange={(event) => setTask({ ...task, assignedUserId: event.target.value || null })} /></label>
